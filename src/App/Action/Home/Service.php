...
class Service
{
    ...
    ) : JsonResponse
    {
        ...
        $homeContentSectionsList = get_field('home_sections_list', $page->ID);
        
        $sectionNumber = 0;
        $responseData = array();

        foreach ($homeContentSectionsList as $section) {
            $sectionNumber++;
            $sectionType = $section['home_sections_list_item_type'];
            $sectionTitle = $section['home_sections_list_item_section_title'];

            switch($sectionType) {
                case 2:
                    $sectionOneEditorContent = $section['home_sections_list_item_rtone_editor'];
                    ...
                    break;
                case 3:
                    $sectionTwoLeftEditorContent = $section['home_sections_list_item_rttwo_left_editor'];
                    $sectionTwoRightEditorContent = $section['home_sections_list_item_rttwo_right_editor'];
                    ...
                    break;
                case 4:
                    $sectionCtaEditorContent = $section['home_sections_list_item_cta_editor'];

                    $sectionCtaLeftButtonText = $section['home_sections_list_item_cta_left_button_text'];
                    $sectionCtaLeftButtonUrl = $section['home_sections_list_item_cta_left_button_url'];
                    $sectionCtaLeftButtonTarget = $section['home_sections_list_item_cta_left_button_target'];

                    $sectionCtaRightButtonText = $section['home_sections_list_item_cta_right_button_text'];
                    $sectionCtaRightButtonUrl = $section['home_sections_list_item_cta_right_button_url'];
                    $sectionCtaRightButtonTarget = $section['home_sections_list_item_cta_right_button_target'];
                    ...
                    break;
                case 5:
                    $sectionSolutionsList = $section['home_sections_list_item_grid_solutions_list'];
                    
                    $sectionSolutionsButtonText = $section['home_sections_list_item_grid_solutions_btn_text'];
                    $sectionSolutionsButtonUrl = $section['home_sections_list_item_grid_solutions_btn_url'];
                    $sectionSolutionsButtonTarget = $section['home_sections_list_item_grid_solutions_btn_target'];
                    ...
                    break;
                case 6:
                    $sectionCoursesList = $section['home_sections_list_item_grid_courses_list'];
                    ...
                    foreach($sectionCoursesList as $course) {
                        ...
                        $courseSubtitle = get_field('course_subtitle', $course->ID);
                    ...
                    break;
                case 7:
                    $sectionInstructorsList = $section['home_sections_list_item_grid_users_list'];
                    ...
                    break;
                case 8:
                    $sectionTestimonialsList = $section['home_sections_list_item_slider_depo_list'];
                ...
                default:
                    ...
                    $sectionBannerSubtitle = $section['home_sections_list_item_banner_subtitle'];
                    
                    $sectionBannerImage = $section['home_sections_list_item_banner_background_image'];
                    ...
                    $sectionBannerButtonText = $section['home_sections_list_item_banner_button_text'];
                    $sectionBannerButtonUrl = $section['home_sections_list_item_banner_button_url'];
                    $sectionBannerButtonTarget = $section['home_sections_list_item_banner_button_target'];
