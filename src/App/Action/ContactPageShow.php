...
class ContactPageShow
{
    public function __invoke(Request $request, Response $responseData, callable $next = null)
    {
        ...
        $contactContentSectionsList = get_field('contact_sections_list', $page->ID);
        
        $sectionNumber = 0;
        $responseData = array();

        foreach ($contactContentSectionsList as $section) {
            $sectionNumber++;
            $sectionType = $section['contact_sections_list_item_type'];
            $sectionTitle = $section['contact_sections_list_item_section_title'];

            switch($sectionType) {
                case 2:
                    $sectionOneEditorContent = $section['contact_sections_list_item_rtone_editor'];
                    ...
                    break;
                case 3:
                    $sectionTwoLeftEditorContent = $section['contact_sections_list_item_rttwo_left_editor'];
                    $sectionTwoRightEditorContent = $section['contact_sections_list_item_rttwo_right_editor'];
                    ...
                    break;
                case 4:
                    $sectionCtaEditorContent = $section['contact_sections_list_item_cta_editor'];

                    $sectionCtaLeftButtonText = $section['contact_sections_list_item_cta_left_button_text'];
                    $sectionCtaLeftButtonUrl = $section['contact_sections_list_item_cta_left_button_url'];
                    $sectionCtaLeftButtonTarget = $section['contact_sections_list_item_cta_left_button_target'];

                    $sectionCtaRightButtonText = $section['contact_sections_list_item_cta_right_button_text'];
                    $sectionCtaRightButtonUrl = $section['contact_sections_list_item_cta_right_button_url'];
                    $sectionCtaRightButtonTarget = $section['contact_sections_list_item_cta_right_button_target'];
                    ...
                    break;
                case 5:
                    $sectionSolutionsList = $section['contact_sections_list_item_grid_solutions_list'];
                    
                    $sectionSolutionsButtonText = $section['contact_sections_list_item_grid_solutions_btn_text'];
                    $sectionSolutionsButtonUrl = $section['contact_sections_list_item_grid_solutions_btn_url'];
                    $sectionSolutionsButtonTarget = $section['contact_sections_list_item_grid_solutions_btn_target'];
                    ...
                    break;
                case 6:
                    $sectionCoursesList = $section['contact_sections_list_item_grid_courses_list'];
                    ...
                    break;
                case 7:
                    $sectionInstructorsList = $section['contact_sections_list_item_grid_users_list'];
                    ...
                    break;
                case 8:
                    $sectionTestimonialsList = $section['contact_sections_list_item_slider_depo_list'];
                ...
                default:
                    ...
                    $sectionBannerSubtitle = $section['contact_sections_list_item_banner_subtitle'];
                    
                    $sectionBannerImage = $section['contact_sections_list_item_banner_background_image'];
                    ...
                    $sectionBannerButtonText = $section['contact_sections_list_item_banner_button_text'];
                    $sectionBannerButtonUrl = $section['contact_sections_list_item_banner_button_url'];
                    $sectionBannerButtonTarget = $section['contact_sections_list_item_banner_button_target'];
        ...
        $fullResponse = array(
            'text_after_form' => get_field('contact_form_subtext_description', $page->ID),
